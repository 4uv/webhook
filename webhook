       ...
       ["content"] = "",
            ["embeds"] = {{
                ...
                ["fields"] = {
                    ...
                    {
                        ["name"] = "__Chemical Egg__",
                        ["value"] = ("%s"):format(comma_Value(math.round(costofegg))),
                        ["inline"] = false
                    },
                    {
                        ["name"] = "__Golden Chemical Egg__",
                ...
                ["fields"] = {
                    {
                        ...
                        ["value"] = comma_Value(difc),
                        ["inline"] = false
                    },
                    {
                        ["name"] = ("__Total Coins This %s Minute Session__"):format(math.round(currentTime/60)),
                        ["value"] = comma_Value(add(tablec)),
                        ["inline"] = false
                    },
                    {
                        ["name"] = "__Average Coins Per Minute__",
                        ["value"] = comma_Value(math.round(add(tablec) / math.round(currentTime/60))),
                        ["inline"] = false
                    },
                }
            }}
